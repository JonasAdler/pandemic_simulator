...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt; font-style:italic; text-decoration: underline;\">Only one of the following can be selected!</span></p></body></html>"))
        ...
        self.healthCareOverloadedCheckBox.setText(_translate("MainWindow", "Health care system overloaded"))
